document.addEventListener('DOMContentLoaded', function () {
  ...
  const sidebarFn = {
    open: () => {
      ...
      btf.animateIn(document.getElementById('menu-mask'), 'https://moonshuo.cn/js/to_show 0.5s')
    ...
    close: () => {
      ...
      btf.animateOut(document.getElementById('menu-mask'), 'https://moonshuo.cn/js/to_hide 0.5s')
  ...
  const scrollFnToDo = function () {
    ...
    if (isToc) {
      ...
      window.mobileToc = {
        ...
        close: () => {
          $cardTocLayout.style.animation = 'https://moonshuo.cn/js/toc-close .2s'
          setTimeout(() => {
